...
CREATE PROCEDURE [dbo].[stpBusca_String_Rotinas_Job]
	@Ds_Busca [varchar](100)
AS
BEGIN
	...
	WHERE
		...
		OR B.command LIKE '%' + C.Ds_Database + '%'
...
EXEC dbo.stpBusca_String_Rotinas
    @Ds_Busca = '.Funcionarios' -- varchar(100)
